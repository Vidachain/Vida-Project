...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* VIDA features */
        {"vida", "listmasternodes", &listmasternodes, true, true, false},
        {"vida", "getmasternodecount", &getmasternodecount, true, true, false},
        {"vida", "masternodeconnect", &masternodeconnect, true, true, false},
        {"vida", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"vida", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"vida", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"vida", "masternodecurrent", &masternodecurrent, true, true, false},
        {"vida", "masternodedebug", &masternodedebug, true, true, false},
        {"vida", "startmasternode", &startmasternode, true, true, false},
        {"vida", "createmasternodekey", &createmasternodekey, true, true, false},
        {"vida", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"vida", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"vida", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"vida", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"vida", "getmasternodescores", &getmasternodescores, true, true, false},
        {"vida", "preparebudget", &preparebudget, true, true, false},
        {"vida", "submitbudget", &submitbudget, true, true, false},
        {"vida", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"vida", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"vida", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"vida", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"vida", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"vida", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"vida", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"vida", "checkbudgets", &checkbudgets, true, true, false},
        {"vida", "mnsync", &mnsync, true, true, false},
        {"vida", "spork", &spork, true, true, false},
        {"vida", "getpoolinfo", &getpoolinfo, true, true, false},
...
//        {"zerocoin", "getzvdaseed", &getzvdaseed, false, false, true},
//        {"zerocoin", "setzvdaseed", &setzvdaseed, false, false, true},
//        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
//        {"zerocoin", "searchdzvda", &searchdzvda, false, false, true},
//        {"zerocoin", "dzvdastate", &dzvdastate, false, false, true},
...
{
    return "> vida-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(std::string methodname, std::string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:20405/\n";
}
