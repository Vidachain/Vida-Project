...
extern UniValue DoZvdaSpend(const CAmount nAmount, bool fMintChange, bool fMinimizeChange, std::vector<CZerocoinMint>& vMintsSelected, std::string address_str, bool isPublicSpend = true);
...
extern UniValue setzvdaseed(const UniValue& params, bool fHelp);
extern UniValue getzvdaseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzvda(const UniValue& params, bool fHelp);
extern UniValue dzvdastate(const UniValue& params, bool fHelp);
