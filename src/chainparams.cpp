...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (0, uint256("0x000009037578d35c64b9b4c6322d2ef96f3eaa0bea70cb9dac38044c6c9fd5eb"))
    (2082, uint256("0x95fa4aaac545ba7fea36ecb619511bd3e5b990939a218a969b86103cc13233b8"));
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1586820999, // * UNIX timestamp of last checkpoint block
    13248,    // * total number of transactions between genesis and last checkpoint
...
public:
    CMainParams()
    {
        ...
        vAlertPubKey = ParseHex("04c2d8c44b4054c5c7b23224fc27dce2315001b123d9bcaaf9c3ff5dc6b9d57806144d9af7025d7750e9092204328c2d666e10a705c99ae0b74aedb64df80c0df0");
        nDefaultPort = 20406;
        ...
        nMinerThreads = 0;
        nTargetSpacing = 60;  // VDA: 10 minutes
        nMaturity = 1440;
        nStakeMinDepth = 600;
        ...
        nLastPOWBlock = 2000;
        nVidaBadBlockTime = 1471401614; // Skip nBit validation of Block 259201 per PR #915
        nVidaBadBlocknBits = 0x1c056dac; // Skip nBit validation of Block 259201 per PR #915
         ...
         *   vMerkleTree: e0028e
         */
        const char* pszTimestamp = "14/May/2020 The Vida Blockchain was Launched!";
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1589471794;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 1062104;

        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x000009037578d35c64b9b4c6322d2ef96f3eaa0bea70cb9dac38044c6c9fd5eb"));
        assert(genesis.hashMerkleRoot == uint256("0x84c8dda2216a74f4420c3071e5a1d688bdcc4e94d915d5c47610954191d3fc71"));

        vSeeds.push_back(CDNSSeedData("178.62.235.217", "178.62.235.217"));
        vSeeds.push_back(CDNSSeedData("165.22.199.99", "165.22.199.99"));
        vSeeds.push_back(CDNSSeedData("178.62.239.38", "178.62.239.38"));
        vSeeds.push_back(CDNSSeedData("165.22.205.146", "165.22.205.146"));
        vSeeds.push_back(CDNSSeedData("178.62.237.72", "178.62.237.72"));
        vSeeds.push_back(CDNSSeedData("178.62.239.28", "178.62.239.28"));
        ...
        base58Prefixes[EXT_COIN_TYPE] = boost::assign::list_of(0x80)(0x00)(0x06)(0xcf).convert_to_container<std::vector<unsigned char> >();
        ...
        strSporkKey = "04A37E463C0D0E661FB8F151645B34E9AD10A7572D0EBAC335C03ACDBD30A7C3E5E4DF80769DD63803A4FAAB11475A3D82A58A27250C5A50FDA73F1F615FFC90C9";
        strSporkKeyOld = "041C244C71819DB35C54582E1882487DA6E24D552AD7E91D3BB331B4899534CC6ABDE2467E69CF770A971FCDBDD454FBBEA8F3A0C589B6513329A39F36E7724CDF";
        ...
        nZerocoinRequiredStakeDepth = 200; //The required confirmations for a zvda to be stakable
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nTargetSpacing = 1 * 60;  // VIDA: 1 minute
        nLastPOWBlock = 200;
        nVidaBadBlockTime = 1489001494; // Skip nBit validation of Block 259201 per PR #915
        nVidaBadBlocknBits = 0x1e0a20bd; // Skip nBit validation of Block 201 per PR #915
        nMaturity = 15;
        nStakeMinDepth = 100;
...
//        assert(hashGenesisBlock == uint256("0x0000041e482b9b9691d98eefb48473405c0b8ec31b76df3797c74a78680ef818"));
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("vida-testnet.seed.vida.com", "vida-testnet.seed.vida.com"));

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet vida addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet vida script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet vida BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet vida BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet vida BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        nMinerThreads = 1;
        nTargetSpacing = 1 * 60;        // VIDA: 1 minutes
