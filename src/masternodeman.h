...
public:
    ...
    void CountTiers(int protocolVersion, int& tier1, int& tier2);
    ...
    CMasternode* GetWinningNode(std::vector<std::pair<int64_t, CTxIn>>& vecMasternodeLastPaid, uint256 blockHash);
