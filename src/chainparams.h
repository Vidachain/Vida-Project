 ...
 * VIDA system. There are three: the main network on which people trade goods
...
public:
    ...
    int VidaBadBlockTime() const { return nVidaBadBlockTime; }
    int VidaBadBlocknBits() const { return nVidaBadBlocknBits; }
...
protected:
    ...
    int nLastPOWBlock;
    int64_t nVidaBadBlockTime;
    unsigned int nVidaBadBlocknBits;
