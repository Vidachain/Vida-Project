...
private:
    ...
    bool CreateBroadcast(CTxIn vin, unsigned int tier, CService service, CKey key, CPubKey pubKey, CKey keyMasternode, CPubKey pubKeyMasternode, std::string& errorMessage, CMasternodeBroadcast &mnb);

    /// Get 10000 VDA input that can be used for the Masternode
