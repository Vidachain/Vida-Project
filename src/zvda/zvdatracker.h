...
#ifndef VIDA_ZVDATRACKER_H
#define VIDA_ZVDATRACKER_H
...
public:
    CzVDATracker(std::string strWalletFile);
    ~CzVDATracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzVDAWallet* zVDAWallet = NULL);
