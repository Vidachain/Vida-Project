...
#ifndef VIDA_ZVDAWALLET_H
#define VIDA_ZVDAWALLET_H
...
public:
    CzVDAWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZVDA(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZVDA(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
