...
/* Vida GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "VIDA"
#define QAPP_ORG_DOMAIN "vida.io"
#define QAPP_APP_NAME_DEFAULT "VIDA-Qt"
#define QAPP_APP_NAME_TESTNET "VIDA-Qt-testnet"
