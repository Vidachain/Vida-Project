                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzVDAPathCustom = GetArg("-zvdabackuppath", "");
    ...
    if(!strzVDAPathCustom.empty()) {
        ui->wallet_customzvdabackuppath->setText(QString::fromStdString(strzVDAPathCustom));
        ui->wallet_customzvdabackuppath_label->setVisible(true);
        ui->wallet_customzvdabackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzVDAPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the VIDA RPC console.") + "<br>" +
