 ...
 */
    ...
    typeWidget->addItem(tr("Minted"), TransactionFilterProxy::TYPE(TransactionRecord::StakeMint) | TransactionFilterProxy::TYPE(TransactionRecord::StakeZVDA));
    typeWidget->addItem(tr("Masternode Reward"), TransactionFilterProxy::TYPE(TransactionRecord::MNReward));
//    typeWidget->addItem(tr("Received VDA from zVDA"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
...
//    typeWidget->addItem(tr("Zerocoin Spend, Change in zVDA"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zVda));
