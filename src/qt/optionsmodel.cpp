...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", BitcoinUnits::VDA);
...
// Wallet
    ...
    if (settings.contains("nAnonymizeVidaAmount"))
        SoftSetArg("-anonymizevidaamount", settings.value("nAnonymizeVidaAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in vida.cpp during shotdown to also remove the window positions
