...
public:
    ...
    void setZVdaControlLabels(int64_t nAmount, int nQuantity);
...
// MINT disabled    void on_pushButtonMintzVDA_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzVDA_clicked();
    void on_pushButtonZVdaControl_clicked();
