...
from fake_stake.base_test import VIDA_FakeStakeTest

class zVDAValidCoinSpendTest(VIDA_FakeStakeTest):
    ...
    def run_test(self):
        ...
        # 2) Mint zerocoins
        self.log.info("Minting %d-denom zVDAs..." % DENOM_TO_USE)
