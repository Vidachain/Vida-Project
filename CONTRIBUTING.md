Contributing to VIDA Core
============================

The VIDA Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/Vidachain/Vida-Project/blob/master/doc/translation_process.md)
...
The following applies to code changes to the VIDA Core project, and is not to be
confused with overall VIDA Network Protocol consensus changes.

Whether a pull request is merged into VIDA Core rests with the project merge
...
Patches that change VIDA consensus rules are considerably more involved than
...
Where a patchset proposes to change the VIDA consensus, it must have been
...
The project leader is the release manager for each VIDA Core release.
