...
RESOURCES += src/qt/vida.qrc src/qt/vida_locale.qrc

TRANSLATIONS += src/qt/locale/vida_bg.ts \
                src/qt/locale/vida_de.ts \
                src/qt/locale/vida_en.ts \
                src/qt/locale/vida_es.ts \
                src/qt/locale/vida_fi.ts \
                src/qt/locale/vida_fr.ts \
                src/qt/locale/vida_it.ts \
                src/qt/locale/vida_ja.ts \
                src/qt/locale/vida_pl.ts \
                src/qt/locale/vida_pt.ts \
                src/qt/locale/vida_ru.ts \
                src/qt/locale/vida_sk.ts \
                src/qt/locale/vida_sv.ts \
                src/qt/locale/vida_vi.ts \
                src/qt/locale/vida_zh_CN.ts \
                src/qt/locale/vida_zh_TW.ts
