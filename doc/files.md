...
vida.conf           | contains configuration settings for vidad or vida-qt
vidad.pid           | stores the process id of vidad while running
...
debug.log           | contains debug information and general logging generated by vidad or vida-qt
